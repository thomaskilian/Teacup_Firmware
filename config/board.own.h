...
#define Z2_STEP_PIN               DIO36
#define Z2_DIR_PIN                DIO34
#define Z2_MIN_PIN                DIO37
#define Z2_ENABLE_PIN             DIO30
#define Z2_INVERT_ENABLE
